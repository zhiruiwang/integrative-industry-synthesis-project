...
**Landing page** — Enter your current occupation and optionally skills, abilities, or knowledge.

![Landing page](img/landing_page.png)

**Results first viewport ** — Details about the current occupation

![Results first viewport](img/results_first_page.png)

**Results second viewport** — Ranked career transitions with similarity scores, growth, salary, and skill gaps.

![Results second viewport](img/results_second_page.png)

**Results third viewport** — 6–12 month narrative career roadmap generated by the roadmap agent.

![Results third viewport](img/results_third_page.png)
